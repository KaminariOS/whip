...
mod platform {
    ...
    use super::{CloseFn, FreeFn, OpenFn, WriteFn};
...
mod platform {
    ...
    static API: Api = Api {
        open: react_native_russh_open_native_length_prefixed_unix_socket_channel,
        write: react_native_russh_write_native_length_prefixed_unix_socket_channel,
