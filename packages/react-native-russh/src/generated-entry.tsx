...
import installer from './NativeRussh';
...
export * from './generated/react_native_russh';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as react_native_russh from './generated/react_native_russh';
...
if (!initialized) {
  react_native_russh.default.initialize();
  initialized = true;
}
