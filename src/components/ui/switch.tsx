  ...
  return (
    <SwitchPrimitives.Root
      className={cn(
        ...
        Platform.select({ web: 'focus-visible:border-ring focus-visible:ring-ring/50 peer inline-flex outline-none transition-all focus-visible:ring-[3px] disabled:cursor-not-allowed' }),
      ...
      <SwitchPrimitives.Thumb
        className={cn(
          ...
          props.checked ? 'dark:bg-primary-foreground translate-x-5' : 'dark:bg-foreground translate-x-0'
        )}
      />
    </SwitchPrimitives.Root>
  );
